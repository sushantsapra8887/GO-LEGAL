  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex justify-center items-center px-4">
      <div className="bg-white rounded-2xl max-w-lg w-full p-6 relative shadow-lg">
        ...
        <p className="italic text-sm text-gray-600 mb-4">{program.eligibility}</p>
...
const ProgramCard = ({ program, delay, onJoinClick }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-md rounded-2xl p-6 bg-white/50 border border-white/30 shadow-xl backdrop-blur-lg text-gray-700"
    >
      ...
      <div className="text-center">
        ...
        <ul className="text-sm text-gray-900 mt-4 mb-6 space-y-2 text-left">
          {program.highlights.map((point, i) => (
            <li key={i} className="flex items-center gap-2">
              <FaCheckCircle className="text-green-400" />
              <span>{point}</span>
    ...
    >
      <div className="bg-white/20 backdrop-blur-md flex-grow">
        ...
        <main className="pt-28 pb-20 px-6 max-w-6xl mx-auto">
          ...
          >
            Practical legal training designed for both students and professionals to help you master courtroom-ready legal skills.
          </motion.p>
